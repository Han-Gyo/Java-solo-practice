...
public class _05_VariableNaming변수이름짓는법 {
    public static void main(String[] args) {
        ...
        String firstName = "한교"; // 이름
        String lastName = "서"; // 성
        String dateOfBirth = "1996-05-29"; // 생년월일
        String residentialAddress = "무슨 호텔"; // 체류지
        String purposeOfVisit = "여행"; // 입국목적
        String flightNo = "KE720"; // 한공 편명
        String _flightNo = "KE720"; // 밑줄 시작
        String flight_no_2 = "KE720"; // 밑줄과 숫자 포함
       // String -flightNo = "KE720";
